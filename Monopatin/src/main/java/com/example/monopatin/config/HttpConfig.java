...
import com.example.monopatin.security.jwt.JwtFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http ) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers( "monopatin/**" ).hasAuthority( AuthorityConstants.ADMIN )
                        .requestMatchers( "pausa/**" ).hasAuthority( AuthorityConstants.ADMIN )
                        .requestMatchers( "precios/**" ).hasAuthority( AuthorityConstants.ADMIN )
                        .requestMatchers( "viajes/**" ).hasAuthority( AuthorityConstants.ADMIN )
                        .requestMatchers( "monopatin/**").hasAuthority(AuthorityConstants.USER)
