package com.example.administracion.config;


import com.example.administracion.security.AuthorityConstants;
import com.example.administracion.security.jwt.JwtFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http ) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth-> auth
                        .requestMatchers( "administrar/**" ).hasAuthority( AuthorityConstants.ADMIN )
