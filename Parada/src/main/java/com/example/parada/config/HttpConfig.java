package com.example.parada.config;


import com.example.parada.security.AuthorityConstants;
import com.example.parada.security.jwt.JwtFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http ) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers( "parada/admin" ).hasAuthority( AuthorityConstants.ADMIN )
                        .requestMatchers( "parada").hasAuthority(AuthorityConstants.USER)
